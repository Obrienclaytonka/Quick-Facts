---
title: |
  ![](C:/R/plots/DEEP_seal.jpg){width=1in}Long Island Sound Water Quality Monitoring Program (LISWQMP)
...
mRefPts <-leaflet() %>% 
  ...
  addCircleMarkers(data=RefPts[RefPts$StationType == 'CTDEEP',], 
                  lng= ~Longitude,
                  lat= ~Latitude, 
                  radius = 2,
                  color = 'blue',
...
addCircleMarkers(data=RefPts[RefPts$StationType == 'UCONN',], 
                  lng= ~Longitude,
                  lat= ~Latitude, 
                  radius = 2,
                  color = 'yellow',
...
More Info: [NERFC Precipitation Totals and Departures from Normal] (https://www.weather.gov/nerfc/watersupply)| [NRCC Summary Tables](https://www.nrcc.cornell.edu/regional/tables/tables.html) |[EPSTAR Drought and Water Resources Guidance](w1.weather.gov/data/TAR/ESPTAR)
